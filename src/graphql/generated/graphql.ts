...
export type GetPostQueryDocumentQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetPostQueryDocumentQuery = {
  __typename?: 'Query';
  getPosts: Array<{
    __typename?: 'Post';
    id: string;
...
export const GetPostQueryDocumentDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'getPostQueryDocument' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetPostQueryDocumentQuery,
  GetPostQueryDocumentQueryVariables
>;
